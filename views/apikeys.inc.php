<?php
if(!$thisstaff->isAdmin()) die('Access Denied');
...
?>
<form action="api" method="POST" name="keys">
    <div class="sticky bar opaque">
        <div class="content">
            ...
            <div class="pull-right">
                <a href="api?a=add" class="green button action-button"><i class="icon-plus-sign"></i> <?php echo __('Add New API Key');?></a>
                ...
                <div id="action-dropdown-more" class="action-dropdown anchor-right">
                    <ul id="actions">
                        <li>
                            <a class="confirm" data-name="enable" href="api?a=enable">
                                <i class="icon-ok-sign icon-fixed-width"></i>
                                <?php echo __( 'Enable'); ?>
                            </a>
                        </li>
                        <li>
                            <a class="confirm" data-name="disable" href="api?a=disable">
                                <i class="icon-ban-circle icon-fixed-width"></i>
                                <?php echo __( 'Disable'); ?>
                            </a>
                        </li>
                        <li class="danger">
                            <a class="confirm" data-name="delete" href="api?a=delete">
...
<input type="hidden" id="action" name="a" value="" >
 <table class="list" border="0" cellspacing="1" cellpadding="0" width="940">
    <thead>
        <tr>
            <th width="4%">&nbsp;</th>
            <th width="46%"><a <?php echo $key_sort; ?> href="api?<?php echo $qstr; ?>&sort=key"><?php echo __('API Key');?></a></th>
            <th width="12%"><a <?php echo $ip_sort; ?> href="api?<?php echo $qstr; ?>&sort=ip"><?php echo __('IP Address');?></a></th>
            <th width="8%"><a  <?php echo $status_sort; ?> href="api?<?php echo $qstr; ?>&sort=status"><?php echo __('Status');?></a></th>
            <th width="10%" nowrap><a  <?php echo $date_sort; ?>href="api?<?php echo $qstr; ?>&sort=date"><?php echo __('Date Added');?></a></th>
            <th width="20%" nowrap><a  <?php echo $updated_sort; ?>href="api?<?php echo $qstr; ?>&sort=updated"><?php echo __('Last Updated');?></a></th>
        </tr>
    </thead>
    <tbody>
    <?php
        ...
        if($res && db_num_rows($res)):
            ...
            <tr id="<?php echo $row['id']; ?>">
                ...
                <td>&nbsp;<a href="api?id=<?php echo $row['id']; ?>"><?php echo Format::htmlchars($row['apikey']); ?></a></td>
