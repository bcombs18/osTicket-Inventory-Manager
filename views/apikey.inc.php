<?php
if(!$thisstaff || !$thisstaff->isAdmin()) die('Access Denied');
...
?>
<form action="api?<?php echo Http::build_query($qs); ?>" method="post" class="save">
 <?php csrf_token(); ?>
    ...
    <tbody>
        ...
        <tr>
            <td colspan=2 style="padding-left:5px">
                <label>
                    <input type="checkbox" name="can_create_assets" value="1" <?php echo $info['can_create_assets']?'checked="checked"':''; ?> >
                    <?php echo __('Can Create Assets <em>(XML/JSON)</em>');?>
                </label>
            </td>
        </tr>
        <tr>
...
<p style="text-align:center">
    ...
    <input type="button" name="cancel" value="<?php echo __('Cancel');?>" onclick='window.location.href="api"'>
</p>
</form>
