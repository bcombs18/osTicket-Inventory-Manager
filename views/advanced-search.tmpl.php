...
if ($parent_id
    ...
    && (!($parent = \model\AssetSavedQueue::lookup($parent_id)))
) {
    $parent_id = 0;
}
...
<div class="tab_content" id="criteria">
  <div class="flex row">
    <div class="span12" style="overflow-y: auto; height:auto;">
     ...
     <?php
        include INVENTORY_VIEWS_DIR . 'advanced-search-criteria.tmpl.php';
     ?>
    </div>
  </div>
...
<div class="tab_content hidden" id="columns">
    <?php
    include INVENTORY_VIEWS_DIR . "queue-columns.tmpl.php";
    ?>
</div>
<?php
if ($search->isSaved()) { ?>
